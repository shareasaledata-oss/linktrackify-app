        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <AnimateOnScroll variants={slideRight}>
              <div className="bg-white rounded-3xl p-10 border border-blue-100 shadow-sm h-full glow-card" onMouseMove={handleTiltMove} onMouseLeave={handleTiltLeave}>
                <div className="shine-overlay" />
                <div className="shine-border" />
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}
            ...
            {pillars.map((p) => (
              <motion.div key={p.title} variants={cardVariant}
                className={`bg-white rounded-2xl p-8 border ${p.border} shadow-sm hover:shadow-md transition-all hover:-translate-y-1 glow-card`} onMouseMove={handleTiltMove} onMouseLeave={handleTiltLeave}>
                <div className="shine-overlay" />
                <div className="shine-border" />
            ...
            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}
              ...
              {methodology.map((m, i) => (
                <motion.div key={m.number} variants={i % 2 === 0 ? slideLeft : slideRight}
                  className="flex gap-6 bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5 glow-card" onMouseMove={handleTiltMove} onMouseLeave={handleTiltLeave}>
                  <div className="shine-overlay" />
                  <div className="shine-border" />
      ...
      <section className="py-24 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimateOnScroll variants={slideRight}>
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-10 text-white glow-card" onMouseMove={handleTiltMove} onMouseLeave={handleTiltLeave}>
                <div className="shine-overlay" />
                <div className="shine-border" />
                <div className="mb-8">
      ...
      <section className="py-24 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <AnimateOnScroll variants={slideLeft}>
              <div className="bg-white rounded-3xl p-10 border border-gray-100 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 flex flex-col h-full glow-card" onMouseMove={handleTiltMove} onMouseLeave={handleTiltLeave}>
                <div className="shine-overlay" />
                <div className="shine-border" />
